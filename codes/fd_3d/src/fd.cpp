...
public:
  ...
  void FormLS(double *bcs)
  {
    ...
    kLOOP jLOOP { int r = pid(       1,       j,       k )  ; A[r][r] = 1.;  b[r] = bcs[1]; }  // i = 1       boundary
    kLOOP jLOOP { int r = pid( ncell_x,       j,       k )  ; A[r][r] = 1.;  b[r] = bcs[2]; }  // i = ncell_x    "
    iLOOP kLOOP { int r = pid(       i,       1,       k )  ; A[r][r] = 1.;  b[r] = bcs[3]; }  // j = 1          "
    iLOOP kLOOP { int r = pid(       i, ncell_y,       k )  ; A[r][r] = 1.;  b[r] = bcs[4]; }  // j = ncell_y    "
    iLOOP jLOOP { int r = pid(       i,       j,       1 )  ; A[r][r] = 1.;  b[r] = bcs[5]; }  // j = 1          "
    
    iLOOP jLOOP { int r = pid(       i,       j, /* TO-DO in Lab */)  ; A[r][r] = 1.;  b[r] = bcs[6]; }  // j = ncell_z boundary

    // Assemble Matrix Rows for Interior Cells
  ...
  // TO-DO in Lab:  Study the "pid" function below.  Convince yourself that it maps an i,j,k cell number
  //                to the "natural" cell/node number.
